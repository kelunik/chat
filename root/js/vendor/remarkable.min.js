...
!function (e) {
    ...
    return function t(e, r, n) {
        ...
        1: [function (e, t) {
            ...
            var n = /[a-zA-Z_:][a-zA-Z0-9:._-]*/, s = /[^"'=<>`\x00-\x20]+/, o = /'[^']*'/, i = /"[^"]*"/, l = r(/(?:unquoted|single_quoted|double_quoted)/)("unquoted", s)("single_quoted", o)("double_quoted", i)(), a = r(/(?:\s+attr_name(?:\s*=\s*attr_value)?)/)("attr_name", n)("attr_value", l)(), c = r(/<[A-Za-z][A-Za-z0-9]*attribute*\s*\/?>/)("attribute", a)(), u = /<\/[A-Za-z][A-Za-z0-9]*\s*>/, p = /<!--([^-]+|[-][^-]+)*-->/, h = /<[?].*?[?]>/, f = /<![A-Z]+\s+[^>]*>/, d = /<!\[CDATA\[([^\]]+|\][^\]]|\]\][^>])*\]\]>/, g = r(/^(?:open_tag|close_tag|comment|processing|declaration|cdata)/)("open_tag", c)("close_tag", u)("comment", p)("processing", h)("declaration", f)("cdata", d)();
            ...
            function f(e) {
                return k.test(e) ? e.replace(y, h) : e
            }

            var d = Object.prototype.hasOwnProperty, g = /\\([\\!"#$%&'()*+,.\/:;<=>?@[\]^_`{|}~-])/g, m = /&([a-z#][a-z0-9]{1,31});/gi, b = /^#((?:x[a-f0-9]{1,8}|[0-9]{1,8}))/i, v = e("./entities"), k = /[&<>"]/, y = /[&<>"]/g, x = {
                "&": "&amp;",
                "<": "&lt;",
                ">": "&gt;",
                '"': "&quot;"
            ...
            "use strict";
            var r = e("./normalize_link"), n = e("../common/utils").unescapeMd;
            t.exports = function (e, t) {
                var s, o, i, l = t, a = e.posMax;
                ...
                for (o = 0; a > t && (s = e.src.charCodeAt(t), 32 !== s) && !(32 > s || 127 === s);)if (92 === s && a > t + 1)t += 2; else {
                    if (40 === s && (o++, o > 1))break;
                    if (41 === s && (o--, 0 > o))break;
                    t++
                }
            ...
            t.exports = function (e, t) {
                var n, s = t, o = e.posMax, i = e.src.charCodeAt(t);
            ...
            var s = e("./common/utils").assign, o = e("./common/utils").isString, i = e("./renderer"), l = e("./parser_core"), a = e("./parser_block"), c = e("./parser_inline"), u = e("./ruler"), p = {
            ...
            var n = e("./ruler"), s = e("./rules_block/state_block"), o = [["code", e("./rules_block/code")], ["fences", e("./rules_block/fences"), ["paragraph", "blockquote", "list"]], ["blockquote", e("./rules_block/blockquote"), ["paragraph", "blockquote", "list"]], ["hr", e("./rules_block/hr"), ["paragraph", "blockquote", "list"]], ["list", e("./rules_block/list"), ["paragraph", "blockquote"]], ["footnote", e("./rules_block/footnote"), ["paragraph"]], ["heading", e("./rules_block/heading"), ["paragraph", "blockquote"]], ["lheading", e("./rules_block/lheading")], ["htmlblock", e("./rules_block/htmlblock"), ["paragraph", "blockquote"]], ["table", e("./rules_block/table"), ["paragraph"]], ["deflist", e("./rules_block/deflist"), ["paragraph"]], ["paragraph", e("./rules_block/paragraph")]];
            ...
            var n = e("./ruler"), s = [["block", e("./rules_core/block")], ["abbr", e("./rules_core/abbr")], ["references", e("./rules_core/references")], ["inline", e("./rules_core/inline")], ["footnote_tail", e("./rules_core/footnote_tail")], ["abbr2", e("./rules_core/abbr2")], ["replacements", e("./rules_core/replacements")], ["smartquotes", e("./rules_core/smartquotes")], ["linkify", e("./rules_core/linkify")]];
            ...
            var s = e("./ruler"), o = e("./rules_inline/state_inline"), i = e("./common/utils").replaceEntities, l = [["text", e("./rules_inline/text")], ["newline", e("./rules_inline/newline")], ["escape", e("./rules_inline/escape")], ["backticks", e("./rules_inline/backticks")], ["del", e("./rules_inline/del")], ["ins", e("./rules_inline/ins")], ["mark", e("./rules_inline/mark")], ["emphasis", e("./rules_inline/emphasis")], ["sub", e("./rules_inline/sub")], ["sup", e("./rules_inline/sup")], ["links", e("./rules_inline/links")], ["footnote_inline", e("./rules_inline/footnote_inline")], ["footnote_ref", e("./rules_inline/footnote_ref")], ["autolink", e("./rules_inline/autolink")], ["htmltag", e("./rules_inline/htmltag")], ["entity", e("./rules_inline/entity")]], a = ["vbscript", "javascript", "file"];
            n.prototype.skipToken = function (e) {
                var t, r, n = e.pos, s = this.ruler.getRules(""), o = s.length;
                if ((r = e.cacheGet(n)) > 0)return void(e.pos = r);
                for (t = 0; o > t; t++)if (s[t](e, !0))return void e.cacheSet(n, e.pos);
            ...
            var o = e("./common/utils").assign, i = e("./common/utils").has, l = e("./common/utils").unescapeMd, a = e("./common/utils").replaceEntities, c = e("./common/utils").escapeHtml, u = {};
            u.blockquote_open = function () {
                ...
                var n = ' src="' + c(e[t].src) + '"', s = e[t].title ? ' title="' + c(a(e[t].title)) + '"' : "", o = ' alt="' + (e[t].alt ? c(a(e[t].alt)) : "") + '"', i = r.xhtmlOut ? " /" : "";
                return "<img" + n + o + s + i + ">"
                ...
                var n, s, o = "", i = this.rules;
                for (n = 0, s = e.length; s > n; n++)o += "inline" === e[n].type ? this.renderInline(e[n].children, t, r) : i[e[n].type](e, n, t, r, this);
                return o
            }, t.exports = s
        }, {"./common/utils": 5}], 19: [function (e, t) {
            "use strict";
            function r() {
                this.rules = [], this.cache = null
            }

            r.prototype.find = function (e) {
                for (var t = 0; t < this.rules.length; t++)if (this.rules[t].name === e)return t;
                return -1
            }, r.prototype.at = function (e, t, r) {
                var n = this.find(e), s = r || {};
                if (-1 === n)throw new Error("Parser rule not found: " + e);
                this.rules[n].fn = t, this.rules[n].alt = s.alt || [], this.cache = null
            }, r.prototype.before = function (e, t, r, n) {
                var s = this.find(e), o = n || {};
                if (-1 === s)throw new Error("Parser rule not found: " + e);
                this.rules.splice(s, 0, {name: t, enabled: !0, fn: r, alt: o.alt || []}), this.cache = null
            }, r.prototype.after = function (e, t, r, n) {
                var s = this.find(e), o = n || {};
                if (-1 === s)throw new Error("Parser rule not found: " + e);
                this.rules.splice(s + 1, 0, {name: t, enabled: !0, fn: r, alt: o.alt || []}), this.cache = null
            }, r.prototype.push = function (e, t, r) {
                var n = r || {};
                this.rules.push({name: e, enabled: !0, fn: t, alt: n.alt || []}), this.cache = null
            }, r.prototype.enable = function (e, t) {
                Array.isArray(e) || (e = [e]), t && this.rules.forEach(function (e) {
                    e.enabled = !1
                }), e.forEach(function (e) {
                    var t = this.find(e);
                    if (0 > t)throw new Error("Rules manager: invalid rule name " + e);
                    this.rules[t].enabled = !0
                }, this), this.cache = null
            }, r.prototype.disable = function (e) {
                Array.isArray(e) || (e = [e]), e.forEach(function (e) {
                    var t = this.find(e);
                    if (0 > t)throw new Error("Rules manager: invalid rule name " + e);
                    this.rules[t].enabled = !1
                }, this), this.cache = null
                ...
                }), e.cache = {}, t.forEach(function (t) {
                    e.cache[t] = [], e.rules.forEach(function (r) {
                        r.enabled && (t && r.alt.indexOf(t) < 0 || e.cache[t].push(r.fn))
                    })
                })
            }, r.prototype.getRules = function (e) {
                return null === this.cache && this.compile(), this.cache[e]
            }, t.exports = r
        }, {}], 20: [function (e, t) {
            "use strict";
            ...
            t.exports = function (e, t, r, n) {
                ...
                return l === c + 2 ? !1 : l + 1 >= u || 58 !== e.src.charCodeAt(++l) ? !1 : n ? !0 : (l++, e.env.footnotes || (e.env.footnotes = {}), e.env.footnotes.refs || (e.env.footnotes.refs = Object.create(null)), a = e.src.slice(c + 2, l - 2), e.env.footnotes.refs[a] = -1, e.tokens.push({
            ...
            t.exports = function (e, t, r, n) {
                ...
                return o > 6 || a > l && 32 !== s ? !1 : n ? !0 : (a = e.skipCharsBack(a, 32, l), i = e.skipCharsBack(a, 35, l), i > l && 32 === e.src.charCodeAt(i - 1) && (a = i), e.line = t + 1, e.tokens.push({
                    ...
                    lines: [t, e.line],
                    children: []
                }), e.tokens.push({type: "heading_close", hLevel: o, level: e.level}), !0)
            }
        }, {}], 26: [function (e, t) {
            "use strict";
            t.exports = function (e, t, r, n) {
            ...
            var n = e("../common/html_blocks"), s = /^<([a-zA-Z]{1,15})[\s\/>]/, o = /^<\/([a-zA-Z]{1,15})[\s>]/;
        ...
        }, {"../common/html_blocks": 2}], 28: [function (e, t) {
            "use strict";
            t.exports = function (e, t, r) {
                var n, s, o, i = t + 1;
            ...
            t.exports = function (e, t, o, i) {
                var l, a, c, u, p, h, f, d, g, m, b, v, k, y, x, _, w, A, q, C, S, M, E = !0;
                if ((d = n(e, t)) >= 0)k = !0; else {
                    if (!((d = r(e, t)) >= 0))return !1;
                    k = !1
                }
                if (e.level >= e.options.maxNesting)return !1;
                if (v = e.src.charCodeAt(d - 1), i)return !0;
                for (x = e.tokens.length, k ? (f = e.bMarks[t] + e.tShift[t], b = Number(e.src.substr(f, d - f - 1)), e.tokens.push({
                    ...
                    lines: w = [t, 0],
                    level: e.level++
                }), l = t, _ = !1, q = e.parser.ruler.getRules("list"); !(!(o > l) || (y = e.skipSpaces(d), g = e.eMarks[l], m = y >= g ? 1 : y - d, m > 4 && (m = 1), 1 > m && (m = 1), a = d - e.bMarks[l] + m, e.tokens.push({
                    type: "list_item_open",
                    lines: A = [t, 0],
                    level: e.level++
                }), u = e.blkIndent, p = e.tight, c = e.tShift[t], h = e.parentType, e.tShift[t] = y - e.bMarks[t], e.blkIndent = a, e.tight = !0, e.parentType = "list", e.parser.tokenize(e, t, o, !0), (!e.tight || _) && (E = !1), _ = e.line - t > 1 && e.isEmpty(e.line - 1), e.blkIndent = u, e.tShift[t] = c, e.tight = p, e.parentType = h, e.tokens.push({
                    type: "list_item_close",
                    level: --e.level
                }), l = t = e.line, A[1] = l, y = e.bMarks[t], l >= o) || e.isEmpty(l) || e.tShift[l] < e.blkIndent);) {
                    for (M = !1, C = 0, S = q.length; S > C; C++)if (q[C](e, l, o, !0)) {
                        M = !0;
                        break
                    }
                    if (M)break;
            ...
            function r(e, t, r, o) {
                ...
                return u = e.slice(2, l), p = e.slice(l + 2, a).trim(), 0 === p.length ? -1 : (o.abbreviations || (o.abbreviations = {}), o.abbreviations[u] = o.abbreviations[u] || p, a)
            }

            var n = e("../rules_inline/state_inline"), s = e("../helpers/parse_link_label");
            t.exports = function (e) {
                var t, n, s, o, i = e.tokens;
                if (!e.inlineMode)for (t = 1, n = i.length - 1; n > t; t++)if ("paragraph_open" === i[t - 1].type && "inline" === i[t].type && "paragraph_close" === i[t + 1].type) {
        ...
        }, {"../helpers/parse_link_label": 12, "../rules_inline/state_inline": 55}], 34: [function (e, t) {
            "use strict";
            function r(e) {
            ...
            t.exports = function (e) {
                ...
                if (e.env.abbreviations)for (e.env.abbrRegExp || (d = "(^|[" + n.split("").map(r).join("") + "])(" + Object.keys(e.env.abbreviations).sort(function (e, t) {
                    return t.length - e.length
                }).map(r).join("|") + ")($|[" + n.split("").map(r).join("") + "])", e.env.abbrRegExp = new RegExp(d, "g")), h = e.env.abbrRegExp, s = 0, o = g.length; o > s; s++)if ("inline" === g[s].type)for (i = g[s].children, t = i.length - 1; t >= 0; t--)if (l = i[t], "text" === l.type) {
                    for (u = 0, a = l.content, h.lastIndex = 0, p = l.level, c = []; f = h.exec(a);)h.lastIndex > u && c.push({
                        type: "text",
                        content: a.slice(u, f.index + f[1].length),
                        level: p
                    }), c.push({type: "abbr_open", title: e.env.abbreviations[f[2]], level: p++}), c.push({
                        type: "text",
                        content: f[2],
                        level: p
                    }), c.push({type: "abbr_close", level: --p}), u = h.lastIndex - f[3].length;
            ...
            "use strict";
            t.exports = function (e) {
                var t, r, n, s, o, i, l, a, c, u = 0, p = !1, h = Object.create(null);
            ...
            var o = e("autolinker"), i = /www|@|\:\/\//;
            t.exports = function (e) {
                var t, o, l, a, c, u, p, h, f, d, g, m, b, v = e.tokens, k = null;
                if (e.options.linkify)for (o = 0, l = v.length; l > o; o++)if ("inline" === v[o].type)for (a = v[o].children, g = 0, t = a.length - 1; t >= 0; t--)if (c = a[t], "link_close" !== c.type) {
            ...
            function r(e, t, r, a) {
                ...
                return h > p && 10 !== c.src.charCodeAt(p) ? -1 : (b = l(e.slice(1, u)), a.references[b] = a.references[b] || {
                    title: m,
                    href: g
                }, p)
            }

            var n = e("../rules_inline/state_inline"), s = e("../helpers/parse_link_label"), o = e("../helpers/parse_link_destination"), i = e("../helpers/parse_link_title"), l = e("../helpers/normalize_reference");
            t.exports = function (e) {
                var t, n, s, o, i = e.tokens;
                if (e.env.references = e.env.references || {}, !e.inlineMode)for (t = 1, n = i.length - 1; n > t; t++)if ("inline" === i[t].type && "paragraph_open" === i[t - 1].type && "paragraph_close" === i[t + 1].type) {
                    for (s = i[t].content; s.length && (o = r(s, e.inline, e.options, e.env), !(0 > o));)s = s.slice(o).trim();
                    i[t].content = s, s.length || (i[t - 1].tight = !0, i[t + 1].tight = !0)
                }
            }
            ...
            var n = /\+-|\.\.|\?\?\?\?|!!!!|,,|--/, s = /\((c|tm|r|p)\)/gi, o = {c: "©", r: "®", p: "§", tm: "™"};
            t.exports = function (e) {
                var t, s, o, i, l;
                if (e.options.typographer)for (l = e.tokens.length - 1; l >= 0; l--)if ("inline" === e.tokens[l].type)for (i = e.tokens[l].children, t = i.length - 1; t >= 0; t--)s = i[t], "text" === s.type && (o = s.content, o = r(o), n.test(o) && (o = o.replace(/\+-/g, "±").replace(/\.{2,}/g, "…").replace(/([?!])…/g, "$1..").replace(/([?!]){4,}/g, "$1$1$1").replace(/,{2,}/g, ",").replace(/(^|[^-])---([^-]|$)/gm, "$1—$2").replace(/(^|\s)--(\s|$)/gm, "$1–$2").replace(/(^|[^-\s])--([^-\s]|$)/gm, "$1–$2")), s.content = o)
            }
        }, {}], 41: [function (e, t) {
            "use strict";
            function r(e, t) {
            ...
            var s = /['"]/, o = /['"]/g, i = /[-\s()\[\]]/, l = "’";
            t.exports = function (e) {
                var t, i, a, c, u, p, h, f, d, g, m, b, v, k, y, x, _;
                if (e.options.typographer)for (_ = [], y = e.tokens.length - 1; y >= 0; y--)if ("inline" === e.tokens[y].type)for (x = e.tokens[y].children, _.length = 0, t = 0; t < x.length; t++)if (i = x[t], "text" === i.type && !s.test(i.text)) {
                    for (h = x[t].level, v = _.length - 1; v >= 0 && !(_[v].level <= h); v--);
                    _.length = v + 1, a = i.content, u = 0, p = a.length;
                    e:for (; p > u && (o.lastIndex = u, c = o.exec(a));)if (f = !r(a, c.index - 1), u = c.index + 1, k = "'" === c[0], d = !r(a, u), d || f) {
                        if (m = !d, b = !f)for (v = _.length - 1; v >= 0 && (g = _[v], !(_[v].level < h)); v--)if (g.single === k && _[v].level === h) {
                            g = _[v], k ? (x[g.token].content = n(x[g.token].content, g.pos, e.options.quotes[2]), i.content = n(i.content, c.index, e.options.quotes[3])) : (x[g.token].content = n(x[g.token].content, g.pos, e.options.quotes[0]), i.content = n(i.content, c.index, e.options.quotes[1])), _.length = v;
                            continue e
                        }
                        m ? _.push({
                            token: t,
            ...
            "use strict";
            var r = e("../common/url_schemas"), n = e("../helpers/normalize_link"), s = /^<([a-zA-Z0-9.!#$%&'*+\/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*)>/, o = /^<([a-zA-Z.\-]{1,25}):([^<>\x00-\x20]*)>/;
            t.exports = function (e, t) {
        ...
        }, {"../common/url_schemas": 4, "../helpers/normalize_link": 9}], 43: [function (e, t) {
            "use strict";
            t.exports = function (e, t) {
            ...
            function n(e, t) {
                var n, s, o, i = t, l = !0, a = !0, c = e.posMax, u = e.src.charCodeAt(t);
            ...
            t.exports = function (e, t) {
                var r, s, o, i, l, a, c, u = e.posMax, p = e.pos, h = e.src.charCodeAt(p);
            ...
            "use strict";
            var r = e("../common/entities"), n = e("../common/utils").has, s = e("../common/utils").isValidEntityCode, o = e("../common/utils").fromCodePoint, i = /^&#((?:x[a-f0-9]{1,8}|[0-9]{1,8}));/i, l = /^&([a-z][a-z0-9]{1,31});/i;
            t.exports = function (e, t) {
                var a, c, u, p = e.pos, h = e.posMax;
                if (38 !== e.src.charCodeAt(p))return !1;
                if (h > p + 1)if (a = e.src.charCodeAt(p + 1), 35 === a) {
        ...
        }, {"../common/entities": 1, "../common/utils": 5}], 47: [function (e, t) {
            "use strict";
            for (var r = [], n = 0; 256 > n; n++)r.push(0);
            "\\!\"#$%&'()*+,./:;<=>?@[]^_`{|}~-".split("").forEach(function (e) {
                r[e.charCodeAt(0)] = 1
            }), t.exports = function (e, t) {
                var n, s = e.pos, o = e.posMax;
            ...
            t.exports = function (e, t) {
                var n, s, o, i, l = e.posMax, a = e.pos;
        ...
        }, {"../helpers/parse_link_label": 12}], 49: [function (e, t) {
            "use strict";
            t.exports = function (e, t) {
                ...
                return n === l + 2 ? !1 : n >= i ? !1 : (n++, r = e.src.slice(l + 2, n - 1), void 0 === e.env.footnotes.refs[r] ? !1 : (t || (e.env.footnotes.list || (e.env.footnotes.list = []), e.env.footnotes.refs[r] < 0 ? (s = e.env.footnotes.list.length, e.env.footnotes.list[s] = {
                    label: r,
                    count: 0
        ...
        }, {"../common/html_re": 3}], 51: [function (e, t) {
            "use strict";
            t.exports = function (e, t) {
                var r, n, s, o, i, l = e.posMax, a = e.pos;
            ...
            "use strict";
            var r = e("../helpers/parse_link_label"), n = e("../helpers/parse_link_destination"), s = e("../helpers/parse_link_title"), o = e("../helpers/normalize_reference");
            t.exports = function (e, t) {
                var i, l, a, c, u, p, h, f, d = !1, g = e.pos, m = e.posMax, b = e.pos, v = e.src.charCodeAt(b);
                ...
                if (p = l + 1, m > p && 40 === e.src.charCodeAt(p)) {
                    ...
                    if (m > p && b !== p && s(e, p))for (u = e.linkContent, p = e.pos; m > p && (f = e.src.charCodeAt(p), 32 === f || 10 === f); p++); else u = "";
            ...
            !function (t, s) {
                ...
                return e.prototype = {
                    ...
                    link: function (t) {
                        var r = this, n = this.getHtmlParser(), s = this.htmlCharacterEntitiesRegex, o = 0, i = [];
                        return n.parse(t, {
                            processHtmlNode: function (e, t, r) {
                                "a" === t && (r ? o = Math.max(o - 1, 0) : o++), i.push(e)
                            }, processTextNode: function (t) {
                                if (0 === o)for (var n = e.Util.splitAndCapture(t, s), l = 0, a = n.length; a > l; l++) {
                                    var c = n[l], u = r.processTextNode(c);
                                    i.push(u)
                                } else i.push(t)
                            }
                        }), i.join("")
                    ...
                    processCandidateMatch: function (t, r, n, s, o, i, l, a, c) {
                        ...
                        return {prefixStr: h, suffixStr: f, matchStr: t, match: u}
                    },
                    ...
                    createMatchReturnVal: function (t, r) {
                        ...
                        var s = this.getTagBuilder(), o = s.build(t);
                        return o.toString()
                    }
                }, e.link = function (t, r) {
                    var n = new e(r);
                    ...
                    htmlRegex: function () {
                        ...
                        t = t || {};
                        for (var r, n = t.processHtmlNode || function () {
                            }, s = t.processTextNode || function () {
                            }, o = this.htmlRegex, i = 0; null !== (r = o.exec(e));) {
                            var l = r[0], a = r[1] || r[3], c = !!r[2], u = e.substring(i, r.index);
