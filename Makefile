...
dist:
	...
	$(BROWSERIFY) $(BROWSERIFY_FLAGS) root/js/transcript.js | $(UGLIFY) $(UGLIFY_FLAGS) > root/js/transcript_bundle.js
...
watch:
	...
	$(WATCHIFY) $(WATCHIFY_FLAGS) root/js/transcript.js -o root/js/transcript_bundle.js --verbose &
	bin/watch_css php &
