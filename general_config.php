...
const UI_CSS_FILES = "vendor/highlight/railscasts.css:font-awesome.min.css:common.css:settings.css:layout.css:room.css:chat_message.css:starred_messages.css:user.css";
